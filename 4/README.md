### Здесь примеры моих запросов в PostgreSQL во время учебы. Это должно показывать мои скилы и заодно моя шпаргалка, так как после учебы практиковат sql мне негде :'(
