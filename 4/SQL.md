### Здесь примеры моих запросов в PostgreSQL во время учебы. Это должно показывать мои скилы и заодно моя шпаргалка, так как после после учебы практиковаться мне негде.
